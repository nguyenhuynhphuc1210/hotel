...
import { 
  ...
  Camera, Loader2, User as UserIcon,
  Tag, MessageSquare, LifeBuoy
} from 'lucide-react'
...
const navItems = [
  ...
  { href: '/admin/support-owner', label: 'Hỗ trợ đối tác', icon: MessageSquare },
  { href: '/admin/support-user', label: 'Hỗ trợ khách hàng', icon: LifeBuoy },
]
