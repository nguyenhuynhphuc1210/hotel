...
import {
    ...
    ShieldCheck, Building2, MessageSquare
} from 'lucide-react'
...
export default function AdminSupportOwnerPage() {
        ...
        const client = new Client({
            ...
            onConnect: () => {
                ...
                client.subscribe('/user/queue/messages', (frame) => {
                    ...
                    qc.invalidateQueries({ queryKey: ['admin-inbox-hotel'] })
                })
                ...
                <div className="px-4 pt-5 pb-4 border-b border-gray-100">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="text-base font-bold text-gray-900">Đối tác khách sạn</h2>
                        </div>
            ...
            {selectedConv ? (
                <div className="flex-1 flex flex-col min-w-0">
                    ...
                    <div className="h-[65px] border-b border-gray-100 px-5 flex items-center gap-3 shrink-0 bg-white">
                        ...
                        <div>
                            <p className="font-semibold text-gray-900 text-sm">{selectedConv.hotelName}</p>
                                    ...
                                    {msgs.map(msg => {
                                        ...
                                        return (
                                            <div key={msg.id} className={`flex gap-2 ${isMine ? 'justify-end' : 'justify-start'}`}>
                                                {!isMine && (
                                                    <div className="w-8 h-8 rounded-xl bg-blue-100 flex items-center justify-center text-blue-700 text-xs font-bold shrink-0 mt-auto mb-5">
                                                        <Building2 size={13} />
                                                    </div>
                                                )}
                    ...
                    <div className="border-t border-gray-100 bg-white px-4 py-3 flex items-center gap-3 shrink-0">
                        <input
                            ...
                            placeholder={`Phản hồi ${selectedConv.hotelName ?? 'đối tác'}...`}
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-4 text-center bg-gray-50/30">
                    ...
                    <div>
                        <p className="font-semibold text-gray-600 text-base">Hỗ trợ đối tác</p>
                        <p className="text-sm text-gray-400 mt-1">Chọn khách sạn bên trái để xem và phản hồi</p>
                    </div>
                    {!isConnected && (
