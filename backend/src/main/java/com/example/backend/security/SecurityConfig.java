    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/room-types/import-template").hasRole("HOTEL_OWNER")
                        .requestMatchers(HttpMethod.POST, "/api/room-types/import").hasRole("HOTEL_OWNER")
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/reviews/*/reply").hasRole("HOTEL_OWNER")
                        .requestMatchers(HttpMethod.PATCH, "/api/reviews/*/report").hasRole("HOTEL_OWNER")
                        .requestMatchers(HttpMethod.PATCH, "/api/reviews/*/toggle-visibility").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/reviews/admin/reported").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/reviews/*/resolve-report").hasRole("ADMIN")
