...
public interface HotelStatisticService {
        ...
        void recordRealtimeStatistic(Hotel hotel, BigDecimal grossAmount, BigDecimal commissionAmount, BigDecimal systemSponsorAmount, BigDecimal netAmount, LocalDate date, BookingStatus status);
