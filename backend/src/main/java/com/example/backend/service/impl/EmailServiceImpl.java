...
public class EmailServiceImpl implements EmailService {
        ...
        public void sendOtpEmail(String to, String otp) {
                ...
                try {
                        ...
                        System.out.println("Send OTP email success: " + to);

                } catch (Exception e) {

                        System.err.println("Send OTP email failed: " + to);
                        e.printStackTrace();
                }
        }
        ...
        public void sendBookingConfirmationEmail(Long bookingId) {
                ...
                for (BookingRoom br : booking.getBookingRooms()) {
                        ...
                        roomDetails.append(br.getQuantity()).append(" x ").append(br.getRoomType().getTypeName())
                                        .append("<br>");
        ...
        public void sendBookingCancellationEmail(Long bookingId, String reason) {
                ...
                String displayReason = (reason != null && !reason.isBlank()) ? reason
                                : "Không có lý do cụ thể được cung cấp từ chỗ nghỉ.";
                ...
                String htmlMsg = "<div style='background-color: #f0f2f5; padding: 30px 10px; font-family: Arial, Helvetica, sans-serif; color: #333; line-height: 1.5;'>"
                                ...
                                + "&nbsp;&nbsp;|&nbsp;&nbsp;<strong>Mã đặt chỗ: " + booking.getBookingCode()
                                + "</strong></p>"
                                ...
                                + "<p style='margin: 5px 0 0 0; font-size: 14px; color: #b91c1c; font-style: italic;'>"
                                + displayReason + "</p>"
                                + "</div>"

                                + "<p style='font-size: 14px; color: #475569; line-height: 1.6; margin-top: 20px;'>"
                                + "Chúng tôi xác nhận đã hủy phòng của quý khách tại <strong>"
                                ...
                                + checkIn
                                + "</p><p style='margin: 0; font-size: 12px; color: #64748b;'>(sau 14:00)</p></td>"
